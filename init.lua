...
vim.g.python3_host_prog = '/Users/richarddonbosco/.py3nvim/bin/python3'
-- [[ Basic Keymaps ]]
...
vim.keymap.set('n', '<leader>sf', require('telescope.builtin').find_files, { desc = 'Find/[S]earch [F]iles' })
...
vim.defer_fn(function()
  require('nvim-treesitter.configs').setup {
    ...
    ensure_installed = { 'c', 'cpp', 'go', 'lua', 'python', 'rust', 'tsx', 'javascript', 'typescript', 'vimdoc', 'vim', 'bash', 'groovy', 'yaml' },
...
local on_attach = function(_, bufnr)
  ...
  nmap('<leader>st', require('telescope.builtin').treesitter, 'Treesitter definitions')
